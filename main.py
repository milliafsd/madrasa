...
def get_ai_analysis(prompt, data_summary):
    try:
        ...
        message = client.messages.create(
            ...
            max_tokens=1500,
            messages=[{"role": "user", "content": f"""آپ ایک تعلیمی مشیر ہیں۔\n{prompt}\nڈیٹا:\n{data_summary}\n\n1. مجموعی کارکردگی\n2. کمزور طلباء\n3. بہتری کی تجاویز\n4. استاد کے لیے سفارشات\n\nاردو میں تجزیہ کریں۔"""}]
        )
...
if st.session_state.user_type == "admin":
    menu = ["📊 ایڈمن ڈیش بورڈ", "📊 یومیہ تعلیمی رپورٹ", "🎓 امتحانی نظام", "📜 ماہانہ رزلٹ کارڈ",
            "📘 پارہ تعلیمی رپورٹ", "🕒 اساتذہ حاضری", "🏛️ رخصت کی منظوری","🤖 AI تجزیہ",
...
# ==================== مکمل AI تجزیہ SECTION ====================
# یہ کوڈ copy کریں اور menu section میں لگائیں
    ...
    with tab1:
        ...
        if students_ai and st.button("🤖 AI تجزیہ شروع کریں", key="ai_monthly"):
            with st.spinner("Claude AI تجزیہ کر رہا ہے..."):
                summary_lines = []
                for stud in students_ai[:20]:  # پہلے 20 طلباء
                    sid = stud["id"]
                    sname = stud["name"]
